...
public class Output {
     ...
     */
    private HashMap<NodeNames, String> stateOutput;
     ...
     */
    public void setInitStateHash(HashMap<NodeNames, String> initStateHash){
     ...
     */
    public String getStateOutput(NodeNames state){
     ...
     */
    public void modifyStateOutput(NodeNames state, String output){
