...
import GUI.SettingsController.SettingsFunction;
...
public class GameScreen extends Screen{
    ...
    private void connectBoardButtons(JLayeredPane layeredPane, BoardGrid grid){
        ...
        for (int i = 0; i< buttons.length; i++){
            ...
            buttons[i].addActionListener(e -> {
                ...
                GUI.Screens.ScreenElements.Popup p = new GUI.Screens.ScreenElements.Popup( popupPanel, new CardShower(num, getCurrentBoard().getCells().get(num), getNumPlayersTile(num)).getContentPanel(), true);
            });
        }
    }
    ...
    public void addTradePopup(String currentPropertyName, String tradingPropertyName){
        ...
        GUI.Screens.ScreenElements.Popup popup = new GUI.Screens.ScreenElements.Popup(tradePopupPanel, optionPanel1.getContentPanel() ,false);
    ...
    public void addPlayerViewerPanel(JLayeredPane pane){
        ...
        for (int i = 0; i<currentBoard.getBasicPlayers().size(); i++){
            ...
            tempButton.addActionListener(e->{
                panel.removeAll();
                GUI.Screens.ScreenElements.Popup popup = new Popup(panel, new PlayerShower(getCurrentBoard().getBasicPlayers().get(finalI)).getContentPanel(),true);
            });
